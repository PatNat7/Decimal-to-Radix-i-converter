...
int main()
{
    ...
    while(D=getD(),D>=0)                                             //Initiate while loop to run whilst D is assigned a value and is greater than or equal to 0
    {
        ...
        res = D/2;                                                            //Calculate the value of the decimal number divided by 2
        printf("The integer result of the number divided by 2 is %d\n",res);  //Display the integer value of 'res'

        rem=D%2;                                                              //Calculate the remainder obtained when the decimal number is divided by 2
